...
export class AllTables1658390515293 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "address" ("id" SERIAL NOT NULL, "zonecode" character varying, "roadAddress" character varying, "jibunAddress" character varying, "latitude" double precision, "longitude" double precision, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "storeId" integer, CONSTRAINT "UQ_7276bf3cdd7a47ababfb749bfc3" UNIQUE ("latitude"), CONSTRAINT "UQ_a95c27477a7d85b1f670682e1ba" UNIQUE ("longitude"), CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "store_styles_style" ("store_id" integer NOT NULL, "style_id" integer NOT NULL, CONSTRAINT "PK_0d7dfbdc002a484081787e115bc" PRIMARY KEY ("store_id", "style_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_3f5e29887f34242fbfdb0e6745" ON "store_styles_style" ("store_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_45dc3fe6ab1b27f83c59d7b9c9" ON "store_styles_style" ("style_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "address" ADD CONSTRAINT "FK_6e7ea53c780aabbea983d443d8a" FOREIGN KEY ("storeId") REFERENCES "store"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "store_styles_style" ADD CONSTRAINT "FK_3f5e29887f34242fbfdb0e67450" FOREIGN KEY ("store_id") REFERENCES "store"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "store_styles_style" ADD CONSTRAINT "FK_45dc3fe6ab1b27f83c59d7b9c96" FOREIGN KEY ("style_id") REFERENCES "style"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "store_styles_style" DROP CONSTRAINT "FK_45dc3fe6ab1b27f83c59d7b9c96"`);
        await queryRunner.query(`ALTER TABLE "store_styles_style" DROP CONSTRAINT "FK_3f5e29887f34242fbfdb0e67450"`);
        ...
        await queryRunner.query(`ALTER TABLE "address" DROP CONSTRAINT "FK_6e7ea53c780aabbea983d443d8a"`);
        await queryRunner.query(`ALTER TABLE "store" DROP CONSTRAINT "FK_98ed391261cdba9f345e4ff24b3"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_45dc3fe6ab1b27f83c59d7b9c9"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3f5e29887f34242fbfdb0e6745"`);
